...
#define PIFS_FLASH_SIZE_FULL_BYTE   (PIFS_FLASH_BLOCK_SIZE_BYTE * PIFS_FLASH_BLOCK_NUM)
#define PIFS_FLASH_SIZE_FS_BYTE     (PIFS_FLASH_BLOCK_SIZE_BYTE * (PIFS_FLASH_BLOCK_NUM - PIFS_FLASH_BLOCK_RESERVED_NUM))
#define PIFS_FLASH_PAGE_ALL_NUM     (PIFS_FLASH_BLOCK_NUM * PIFS_FLASH_PAGE_PER_BLOCK)
#define PIFS_FLASH_PAGE_FS_NUM      ((PIFS_FLASH_BLOCK_NUM - PIFS_FLASH_BLOCK_RESERVED_NUM) * PIFS_FLASH_PAGE_PER_BLOCK)

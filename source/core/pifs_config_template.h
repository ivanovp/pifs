 ...
 * Last modify: 2018-02-10 08:22:11 ivanovp {Time-stamp}
 * Licence:     GPL
 *
...
#define PIFS_SEPARATE_WORKDIR_FOR_TASKS 1u  /**< 1: Each task have its own working directory, 0: common working directory */
